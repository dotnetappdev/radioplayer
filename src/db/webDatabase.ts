...
class WebDatabaseService {
  private mockStations: RadioStation[] = [
    ...
    },
    {
      id: 39,
      name: 'Kerrang! Radio',
      streamUrl: 'http://icy-e-bab-04-gos2.sharp-stream.com/kerrang.mp3',
      genre: 'rock',
      country: 'UK',
    ...
    },
    {
      id: 40,
      name: 'Rock FM',
      streamUrl: 'https://rockfm.planetradio.co.uk/stream',
      genre: 'rock',
      country: 'UK',
    ...
    },
    {
      id: 41,
      name: 'Q104.3',
      streamUrl: 'https://playerservices.streamtheworld.com/api/livestream-redirect/WAXQFMAAC.aac',
      genre: 'rock',
      country: 'US',
    ...
    },
    {
      id: 42,
      name: 'KROQ',
      streamUrl: 'https://playerservices.streamtheworld.com/api/livestream-redirect/KROQFMAAC.aac',
      genre: 'rock',
      country: 'US',
      description: 'Los Angeles alternative rock',
      isFavorite: false,
      streamType: StreamType.HTTPS,
      isUserAdded: false,
    },
    ...
    // Easy Listening Stations
    {
      id: 43,
      name: 'Magic Chilled',
      streamUrl: 'http://media-ssl.musicradio.com/MagicChilledMP3',
      genre: 'pop',
      country: 'UK',
      description: 'Relaxing easy listening music',
      isFavorite: false,
      streamType: StreamType.HTTP,
      isUserAdded: false,
    },
    {
      ...
      streamUrl: 'https://server1.streamserver24.com:8076/stream',
      genre: 'jazz',
      country: 'US',
      description: 'Smooth jazz and instrumental music',
      isFavorite: false,
      streamType: StreamType.HTTPS,
      isUserAdded: false,
    },
    {
      id: 45,
      name: 'Lite FM',
      streamUrl: 'https://playerservices.streamtheworld.com/api/livestream-redirect/WLTWAAC.aac',
      genre: 'pop',
      country: 'US',
      description: 'New York\'s relaxing favorites',
      isFavorite: false,
      streamType: StreamType.HTTPS,
      isUserAdded: false,
    },
    {
      id: 46,
      name: 'Calm Radio Classical',
      streamUrl: 'https://streams.calmradio.com/api/39/128/stream',
      genre: 'classical',
      country: 'Canada',
    ...
    // Additional Pop Stations
    {
      ...
      genre: 'pop',
      country: 'France',
      description: 'Hit music from France',
      isFavorite: false,
      streamType: StreamType.HTTPS,
      isUserAdded: false,
    },
    {
      id: 48,
      name: 'Radio 2 Germany',
      streamUrl: 'https://dispatcher.rndfnk.com/wdr/wdr2/rheinland/mp3/128/stream.mp3',
      genre: 'pop',
      country: 'Germany',
      description: 'Popular music from Germany',
      isFavorite: false,
      streamType: StreamType.HTTPS,
      isUserAdded: false,
    },
    {
      id: 49,
      name: 'Mix 104.1',
      streamUrl: 'https://playerservices.streamtheworld.com/api/livestream-redirect/WMXJAAC.aac',
      genre: 'pop',
      country: 'US',
      description: 'Boston\'s variety hits',
      isFavorite: false,
      streamType: StreamType.HTTPS,
      isUserAdded: false,
    },
    {
      id: 50,
      name: 'KIIS FM',
      streamUrl: 'https://playerservices.streamtheworld.com/api/livestream-redirect/KIISFMAAC.aac',
      genre: 'pop',
      country: 'US',
      description: 'Los Angeles\' #1 hit music station',
      isFavorite: false,
      streamType: StreamType.HTTPS,
      isUserAdded: false,
    },

    // Additional World Stations
    {
      id: 51,
      ...
      genre: 'news',
      country: 'Germany',
      description: 'German public radio news and culture',
      isFavorite: false,
      streamType: StreamType.HTTPS,
      isUserAdded: false,
    },
    {
      id: 52,
      name: 'Radio Nacional España',
      streamUrl: 'https://rtvehlsvodlive.rtve.es/rne/rne_r1_main_720.m3u8',
      genre: 'news',
      country: 'Spain',
    ...
    },
    {
      ...
      genre: 'news',
      country: 'Italy',
      description: 'Italian public radio',
      isFavorite: false,
      streamType: StreamType.HTTPS,
      isUserAdded: false,
    },
    {
      ...
      streamUrl: 'https://http-live.sr.se/p1-mp3-192',
      genre: 'news',
      country: 'Sweden',
      description: 'Swedish public radio news and culture',
      isFavorite: false,
      streamType: StreamType.HTTPS,
      isUserAdded: false,
    },
    {
      ...
      streamUrl: 'https://amp.cesnet.cz:8443/cro-radio-praha.mp3',
      genre: 'news',
      country: 'Czech Republic',
      description: 'Czech international broadcasting',
      isFavorite: false,
      streamType: StreamType.HTTPS,
      isUserAdded: false,
    },
    {
      id: 56,
      name: 'CNN Radio',
      streamUrl: 'https://playerservices.streamtheworld.com/api/livestream-redirect/CNN_NEWSROOM.mp3',
      genre: 'news',
      country: 'US',
      description: 'International news from CNN',
      isFavorite: false,
      streamType: StreamType.HTTPS,
      isUserAdded: false,
    },
    {
      id: 57,
      name: 'JJJ Unearthed',
      streamUrl: 'https://live-radio01.mediahubaustralia.com/2TJJ/mp3/',
      genre: 'alternative',
      country: 'Australia',
      description: 'New Australian music discovery',
      isFavorite: false,
      streamType: StreamType.HTTPS,
      isUserAdded: false,
    },
    {
      id: 58,
      name: 'Radio 3 Netherlands',
      streamUrl: 'https://icecast.omroep.nl/3fm-bb-mp3',
      genre: 'alternative',
      country: 'Netherlands',
      description: 'Alternative music from the Netherlands',
      isFavorite: false,
      streamType: StreamType.HTTPS,
      isUserAdded: false,
    },
    {
      id: 59,
      name: 'WXPN',
      streamUrl: 'https://playerservices.streamtheworld.com/api/livestream-redirect/WXPNFM.mp3',
      genre: 'alternative',
      country: 'US',
      description: 'Philadelphia\'s alternative public radio',
      isFavorite: false,
      streamType: StreamType.HTTPS,
      isUserAdded: false,
    },
    {
      id: 60,
      name: 'Absolute 80s',
      streamUrl: 'http://icy-e-bab-04-gos2.sharp-stream.com/absolute80s.mp3',
      genre: 'pop',
      country: 'UK',
      description: 'The biggest hits from the 80s',
      isFavorite: false,
      streamType: StreamType.HTTP,
      isUserAdded: false,
    },
